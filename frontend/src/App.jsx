  ...
  return (
    ...
    >
      <div style={{
        ...
        {/* Center — step breadcrumb OR side-screen label */}
        {isSideScreen ? (
          <span style={{
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: done ? 'pointer' : active ? 'default' : 'default',
                    fontFamily: 'var(--font-mono)',
                    fontSize: '11px',
                    letterSpacing: '0.5px',
                    color: active ? 'var(--text-0)'
                         : done   ? 'var(--text-2)'
                         :          'var(--text-3)',
                ...
                >
                  {done && (
                    <span style={{ marginRight: '4px', color: 'var(--green)', fontSize: '9px' }}>✓</span>
                  )}
                  {step}
                  {/* Active underline */}
                  {active && (
                    <span style={{
                      ...
                      height: '1px', background: 'var(--text-0)', borderRadius: '999px',
                    }} />
                  )}
                  {/* Separator */}
                  {i < STEPS.length - 1 && (
        ...
        {/* Right — utility actions + active player */}
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-0)' }}>
      ...
      <div style={{ paddingTop: isSearch ? 0 : '56px' }}>
